...
//   if (!bus) {
//     return <div>No bus details found!</div>;
//   }
...
//   const handleBooking = () => {
//     navigate(`/booking/${bus.id}`, { state: { selectedSeats } });
//   };
...
//           <div className="text-xl">{bus.type}</div>
//         </div>

//         <div>
//           <p>From: {bus.from}</p>
//           <p>To: {bus.to}</p>
//           <p>Boarding Points: {bus.boardingPoints.join(", ")}</p>
//           <p>Dropping Points: {bus.droppingPoints.join(", ")}</p>
//           <p>Price: ₹{bus.price}</p>
//         </div>

//         {/* Seat selection UI (you can expand based on requirements) */}
