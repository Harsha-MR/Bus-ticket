...
// import Bus from "../models/Bus.js";
// import Route from "../models/Route.js";
// import { sendTicketEmail, sendEmail } from "../services/emailservice.js";
// import User from "../models/userModel.js";
// import { generateTicketPDF } from "../services/pdfgenerator.js";
// import { z } from "zod";

// // Zod schema for booking seats
...
//   seats: z
//     .array(z.string().nonempty("Seat identifier must be a non-empty string."))
//     .min(1, "At least one seat must be selected."),
// });

// // Zod schema for canceling a booking
...
//     const { busId, from, to, seats } = bookSeatsSchema.parse(req.body);
//     const userId = req.user.id;
//     const userEmail = req.user.email;
//     const userName = req.user.name;
...
//       to,
//       seatNumbers: seats,
//       journeyStartTime: new Date(bus.startTime),
//       journeyEndTime: new Date(bus.endTime),
//     });
...
//       <p>Please find your ticket attached as a PDF.</p>
//     `;
//     await sendTicketEmail(userEmail, emailSubject, emailText, emailHtml, filePath);
